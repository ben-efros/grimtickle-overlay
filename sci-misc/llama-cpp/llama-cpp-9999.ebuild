...
#
# Based on the GURU overlay's sci-misc/llama-cpp-9999.ebuild
# (https://gitweb.gentoo.org/repo/proj/guru.git/tree/sci-misc/llama-cpp),
# imported into grimtickle-overlay to track a live (-9999) build of
# llama.cpp with Vulkan (PanVK/Panfrost) support for the CIX Sky1
# Immortalis-G720 GPU. ROCm/CUDA support is retained from upstream but is
# not applicable/tested on this aarch64 platform.
